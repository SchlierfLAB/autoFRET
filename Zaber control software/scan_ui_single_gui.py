...
class Ui_MainWindow_Single(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.homeButton.setText(_translate("MainWindow", "Move to single well"))
        self.closeConnButton.setText(_translate("MainWindow", "Close connection"))
        self.setHomeButton.setText(_translate("MainWindow", "Set well position"))
        ...
        self.measTime_label.setText(_translate("MainWindow", "Measurement time (minutes)"))
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindow_Single()
    ui.setupUi(MainWindow)
    MainWindow.setWindowTitle('Single Well Measurement')
    MainWindow.show()
    sys.exit(app.exec_())
